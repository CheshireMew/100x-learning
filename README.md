...
| 写成文章 | 整理现有材料，按需联网补充，再直接成文 | 可使用的文章或 Newsletter |
...
接入后，私人库可以保存来源、同主题知识真源、完整写作案例、独立钩子、确认后的作品、内容方向和持续选题状态。普通文章写作只读取文章案例和钩子，不会自动把主题知识、作者声音或发布历史带入新稿；这些资料只有在你明确要求对应结果时才使用。单次发布表现也不会自动改写长期策略或个人声音。
...
这个 Skill 负责理解材料、研究主题、解释概念、设计实践、审查内容，以及写作文章和 Newsletter。短帖、Thread、GitHub 项目短介绍与清单、项目或产品短宣发文案，以及图片、GIF、视频、音频与播客制作、普通翻译、广告投放、销售页、邮件营销、品牌全案、完整营销策略和实际发布，不在它的交付范围内。
