...
接入后，私人库可以保存来源、同主题知识真源、完整写作案例、独立钩子、确认后的作品、内容方向和持续选题状态。普通写作使用仓库内经过验证的完整写作模板，不读取私人案例、钩子、主题知识、作者声音或发布历史；这些资料只有在你明确要求维护语料、模板、声音或历史时才使用。单次发布表现也不会自动改写长期策略或个人声音。
